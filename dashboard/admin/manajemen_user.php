         ...
         <div class="page-content--bgf7">
             ...
             <div class="col-lg-12">
               ...
               <table class="table table-borderless table-striped table-earning">
                   ...
                   <tbody>
                      <?php while ($datauser1 = mysqli_fetch_assoc($queryuser1)) { ?>
                        <tr>
                        <?php if ($datauser1['poin'] == 0) { ?>
                          <td class="text-center"><?php echo $datauser1["email"]; ?></td>
                          <td class="text-center"><?php echo $datauser1["npm"]; ?></td>
                          <td class="text-center"><?php echo $datauser1["nama"]; ?></td>
                          <td class="text-center"><?php echo $datauser1["password_asli"]; ?></td>
                          <td class="text-center"> <img src="../../images/<?php echo $datauser1['foto']  ?>" height=100px width=200px> </td>
                          <td class="text-center">
                          <a href="<?php echo "prosesverifuser.php?user=".$datauser1['npm']; ?>" type="button" class="btn btn-success btn-sm">Accept</a>
                          <a href="<?php echo "proseshapususer.php?user=".$datauser1['npm']; ?>" type="button" class="btn btn-danger btn-sm">Reject</a>
                          </td>
                             <?php } else { ?>
                             <?php } ?>
                       </tr>
                          ...
                          <?php while ($datauser = mysqli_fetch_assoc($queryuser)) { ?>
                            ...
                            <?php if ($datauser['poin'] == 1) { ?>
                              ...
                              <td class="text-center">
                                ...
                                <a href="<?php echo "../user/user/nonaktifuser.php?user=".$datauser['npm']; ?>" type="button" class="btn btn-outline-danger btn-sm">Nonaktif</a>
                              </td>
                            <?php } elseif ($datauser['poin'] == 2) { ?>
                                   ...
                                   <td class="text-center"><?php echo $datauser["password_asli"]; ?></td>
                                   <td class="text-center">
                                     <a href="<?php echo "../user/user/aktifuser.php?user=".$datauser['npm']; ?>" type="button" class="btn btn-outline-success btn-sm">Aktif</a>
