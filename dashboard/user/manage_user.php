                ...
                <div class="card-body card-block">
                    <form action="prosesubahpassword.php" method="post">
                        <div class="form-group">
                            <label for="nf-email" class=" form-control-label mt-4"><strong>Old Password</strong></label>
                            <input type="password" id="password" name="password" placeholder="Enter your old password" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="nf-password" class=" form-control-label"><strong>New Password</strong></label>
                            <input type="password" id="password_new" name="password_new" placeholder="Enter your new password" class="form-control">
                            <br>
                            <span class="help-block"><strong>Please re-enter your new password</strong></span>
                            <br>
                            <input type="password" id="password_new_asli" name="password_new_asli" placeholder="Re-enter your new password" class="form-control">
                        </div>
                        <button type="submit" class="btn btn-primary btn-sm">
                            <i class="fas fa-fw fa-wrench"></i> Change
                        </button>
                        <a href="profile_user.php" class="btn btn-danger btn-sm">
