...
$informatika = mysqli_query($koneksi, "SELECT * FROM user WHERE npm LIKE '%081%'");
$informatika = mysqli_fetch_array($informatika);

$sifo = mysqli_query($koneksi, "SELECT * FROM user WHERE npm LIKE '%082%'");
$sifo = mysqli_fetch_array($sifo);
    ...
    <div class="page-wrapper">
        ...
        <div class="card ml-5 mr-5">
            <div class="card-header text-white bg-success text-center">
                <strong>Surat Pernyataan Masih Kuliah / Mahasiswa Aktif</strong>
            </div>
            <div class="card-body card-block">
                <form action="prosesmahasiswa_aktif.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label class=" form-control-label"><strong>Data Mahasiswa</strong></label>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                        ...
                        <div class="col-12 col-md-4">
                            <input type="text" id="tahunakademik" name="tahunakademik" value="<?php echo $akademik; ?>" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="email-input" class=" form-control-label">NPM</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="npm" name="npm" value="<?php echo $data['npm']; ?>" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="password-input" class=" form-control-label">Semester</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="semester" name="semester" placeholder="Masukkan semester anda" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label class=" form-control-label"><strong>Data Orang Tua</strong></label>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="nama_ortu" name="nama_ortu" placeholder="Masukkan nama lengkap orang tua anda" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">No. Pegawai / NIP / NRP</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="nip" name="nip" placeholder="Masukkan no. pegawai orang tua anda" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Pangkat / Golongan</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="pangkat" name="pangkat" placeholder="Masukkan pangkat atau gologan orang tua anda" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label">Instansi / Pekerjaan</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="instansi" name="instansi" placeholder="Masukkan instansi / pekerjaan orang tua anda" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label class=" form-control-label"><strong>NB :</strong></label>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="file-input" class=" form-control-label">Bukti Heregistrasi / Pembayaran Ybs.</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="file" id="foto_pembayaran" name="foto_pembayaran" class="form-control-file" required>
                        </div>
                    </div>
            </div>
